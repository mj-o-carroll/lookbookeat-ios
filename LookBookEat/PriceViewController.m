...
@synthesize restaurantsController, delegate, price;
...
- (void)viewDidLoad
{
    ...
    selectedIndex = [[restaurantsController availablePrices] indexOfObject:self.price];
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [[restaurantsController  availablePrices] count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Configure the cell...
	NSString * possiblePrices = [[restaurantsController availablePrices] objectAtIndex:indexPath.row];
    [cell.textLabel setFont:[UIFont fontWithName:@"Avenir" size:17.0]];
	cell.textLabel.text = possiblePrices;
...
didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	NSString *thePrice = [[restaurantsController availablePrices] objectAtIndex:indexPath.row];
	[self.delegate priceViewController:self didSelectPrice:thePrice];
}
